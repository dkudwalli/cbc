...
<div class="imi-sermon-id" data-sermon="<?php echo get_the_ID(); ?>"></div>
<div class="container">
  <div class="row main-content-row">
    <div class="<?php echo esc_attr($pageOptions['class']); ?>" id="content-col">
      <header class="single-post-header clearfix">
        <div class="float-end sermon-actions">
          <?php
          ...
          if (!empty($custom_video_mp4) || !empty($custom['imic_sermons_url'][0])) {
            echo '<a href="' . $Final_Video_URL . '" class="play-video-link" data-placement="top" data-bs-toggle="tooltip" data-original-title="' . esc_html__('Video', 'framework') . '" rel="tooltip"><i class="fa fa-video-camera"></i></a>';
          }
          $attach_full_audio = imic_sermon_attach_full_audio(get_the_ID());
          if (!empty($attach_full_audio)) {
            echo '<a href="' . $attach_full_audio . '" class="play-audio-link" data-placement="top" data-bs-toggle="tooltip" data-original-title="' . esc_html__('Audio', 'framework') . '" rel="tooltip"><i class="fa fa-headphones"></i></a>';
          }
          if (!empty($attach_full_audio)) {
            echo '<a href="' .  $attach_full_audio . '" download class="download-audio-link" data-placement="top" data-bs-toggle="tooltip" data-original-title="' . esc_html__('Download Audio', 'framework') . '" rel="tooltip"><i class="fa fa-download"></i></a>';
          }
          $attach_pdf = imic_sermon_attach_full_pdf(get_the_ID());
          if (!empty($attach_pdf)) {
            echo '<a href="'  . $attach_pdf . '" download class="download-pdf-link" data-placement="top" data-bs-toggle="tooltip" data-original-title="' . esc_html__('Download PDF', 'framework') . '" rel="tooltip"><i class="fa fa-book"></i></a>';
          }
          ?>
        </div>
      ...
      <article class="post-content">
        ...
        <div class="tabs" id="additional-media-sermons">
          <ul class="nav nav-tabs">
            <?php if (!empty($add_custom_video_mp4)) { ?><li> <a data-bs-toggle="tab" href="#addvideo"> <i class="fa fa-video-camera"></i> </a> </li><?php } ?>
            <?php if (!empty($add_vimeo_video_url)) { ?><li> <a data-bs-toggle="tab" href="#addvimeo"> <i class="fa fa-vimeo-square"></i> </a> </li><?php } ?>
            <?php if (!empty($add_youtube_video_url)) { ?><li> <a data-bs-toggle="tab" href="#addyoutube"> <i class="fa fa-youtube"></i> </a> </li><?php } ?>
            <?php if (!empty($add_soundcloud_audio_url)) { ?><li> <a data-bs-toggle="tab" href="#addsoundcloud"> <i class="fa fa-soundcloud"></i> </a> </li><?php } ?>
          </ul>
        ...
        if (isset($options['switch_sharing']) && $options['switch_sharing'] == 1) {
          if ($options['share_post_types']['4'] == '1') {
            imic_share_buttons();
          }
        } ?>
      </article>
