...
15 July 2024 - Version 4.7.3
	UPDATED! Revolution Slider Plugin
	UPDATED! Eventer Plugin
	UPDATED! Pro Elements Plugin
	UPDATED! Compatibility with WP version 6.5.5

10 June 2024 - Version 4.7.2.1
	UPDATED! Revolution Slider Plugin

09 June 2024 - Version 4.7.2
	UPDATED! Revolution Slider Plugin
	UPDATED! Eventer Plugin
	UPDATED! iSermons Plugin
	UPDATED! Pro Elements Plugin
	UPDATED! Compatibility with WP version 6.5.4

30 May 2024 - Version 4.7.1
	UPDATED! Revolution Slider Plugin
	UPDATED! Compatibility with WP version 6.5.3

22 April 2024 - Version 4.7
	NEW! Added option to show event date as default(set at settings general) format for events minimal grid SiteOrigins widget 
	UPDATED! Revolution Slider Plugin
	UPDATED! Eventer Plugin
	UPDATED! iSermons Plugin
	UPDATED! Pro Elements Plugin
	UPDATED! NativeChurch Core plugin
	UPDATED! Compatibility with WP version 6.5.2

12 February 2024 - Version 4.6.6
	UPDATED! Revolution Slider Plugin
	UPDATED! Eventer Plugin
	UPDATED! Twitter icon to X
	UPDATED! Compatibility with WP version 6.4.3

16 December 2023 - Version 4.6.5.1
	UPDATED! Revolution Slider Plugin
	UPDATED! Pro Elements Plugin
	UPDATED! Compatibility with WP version 6.4+

22 November 2023 - Version 4.6.5
	NEW! Option to add selected sermon categories in the sermons album SiteOrigins page builder widget
	UPDATED! NativeChurch Core plugin
	UPDATED! Revolution Slider Plugin
	UPDATED! Pro Elements Plugin
	UPDATED! Eventer Plugin
...
01 October 2023 - Version 4.6.4
	UPDATED! NativeChurch Core plugin
	UPDATED! Revolution Slider Plugin
	UPDATED! Pro Elements Plugin
	UPDATED! iSermons Plugin
	UPDATED! Eventer Plugin
	UPDATED! Compatibility with WP version 6.3+
	UPDATED! Compatibility with PHP version 8.2+

26 June 2023 - Version 4.6.3
	UPDATED! NativeChurch Core plugin
	UPDATED! Revolution Slider Plugin
	UPDATED! Pro Elements Plugin
	UPDATED! iSermons Plugin
...
17 April 2023 - Version 4.6.2
	UPDATED! NativeChurch Core plugin
	UPDATED! Revolution Slider Plugin

26 March 2023 - Version 4.6.1
	UPDATED! NativeChurch Core plugin

25 March 2023 - Version 4.6
	NEW! Buddhism Elementor Demo
	UPDATED! NativeChurch Core plugin
	UPDATED! Pro Elements Plugin
	UPDATED! Eventer Plugin
	UPDATED! iSermons Plugin
...
05 March 2023 - Version 4.5
	UPDATED! NativeChurch Core plugin
	UPDATED! Revolution Slider Plugin
	UPDATED! Pro Elements Plugin
	UPDATED! imi causes Plugin
	UPDATED! Eventer Plugin
	UPDATED! iSermons Plugin
	UPDATED! Demo data
	FIXED! iSermons Elementor widget not allowing a single taxonomy display	

08 September 2022 - Version 4.4
	NEW! Classic Elementor Demo
	UPDATED! NativeChurch Core plugin
	UPDATED! Pro Elements Plugin

27 July 2022 - Version 4.3.2
	UPDATED! NativeChurch Core plugin
	UPDATED! Eventer Plugin

21 July 2022 - Version 4.3.1
	UPDATED! Theme Options Panel

20 July 2022 - Version 4.3
	UPDATED! NativeChurch Core plugin
	UPDATED! iSermons Plugin

24 June 2022 - Version 4.2
	UPDATED! NativeChurch Core plugin
	UPDATED! Revolution Slider Plugin
...
05 August 2021 - Version 3.9.1.1
	FIXED! Problem with slider revolution on the homepage

04 August 2021 - Version 3.9.1
	FIXED! Problem with slider revolution on the homepage
	FIXED! Some styling bugs

03 August 2021 - Version 3.9
...
29 January 2021 - Version 3.6.3
	NEW! Option to style mobile menu toggle buttons
	UPDATED! Revolution Slider

17 January 2021 - Version 3.6.2
