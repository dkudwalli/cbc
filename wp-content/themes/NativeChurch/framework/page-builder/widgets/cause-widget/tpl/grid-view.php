...
if (function_exists('causes_option_page')) { ?>
  ...
  if (have_posts()) :
    ...
    <?php }  ?>
    <ul class="grid-holder col-<?php echo esc_attr($grid_column); ?> causes-grid">
          ...
          <li class="grid-item cause-item format-standard">
            <div class="grid-item-inner">
              ...
              echo imic_excerpt(50); ?>
                <a href="#" id="donate-popup" class="btn btn-default donate-paypal" data-bs-toggle="modal" data-bs-target="#PaymentModal-<?php echo get_the_ID(); ?>"><?php _e('Donate Now', 'framework'); ?></a>
              </div>
            </div>
          </li>
        <?php }
