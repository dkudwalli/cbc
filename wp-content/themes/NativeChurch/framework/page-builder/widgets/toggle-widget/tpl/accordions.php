...
<div class="accordion" id="<?php echo esc_attr($tabid); ?>">
	...
	{ $class=''; $classs=''; }
      	$output.='<div class="accordion-group panel accordion-panel">
                        <div class="accordion-heading accordionize"> <a class="accordion-toggle '.$class.'" data-bs-toggle="collapse" data-parent="#'.$tabid.'" href="#Area_'.$tabid.$i.'">'.wp_kses_post( $tab['tab_nav_title'] ).'<i class="fa fa-angle-down"></i> </a> </div>';
