                    ...
                    <article class="cause-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
								...
								<?php if($days_left>=0) {
									if($cause_custom_donation != ''){ ?>
										<a href="<?php echo esc_url($cause_custom_donation); ?>" <?php if($cause_custom_donation_window){ echo 'target="_blank"'; } ?> class="btn btn-primary btn-lg btn-block"><?php _e('Donate Now', 'framework'); ?></a>
									<?php } else { ?>
										<a href="#" id="donate-popup" class="btn btn-primary btn-lg btn-block donate-paypal" data-bs-toggle="modal" data-bs-target="#PaymentModal"><?php _e('Donate Now', 'framework'); ?></a>
									<?php }
								} ?>
                            </div>
                        </div>
