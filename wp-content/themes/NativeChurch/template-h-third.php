...
if ($imic_upcoming_events_area == 1) {
    if ($imic_upcoming_events_area == '1' && $imic_latest_sermon_events == 'letest_event') { ?>
        <div class="notice-bar">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-6 notice-bar-title">
                    <span class="notice-bar-title-icon d-none d-sm-block"><i class="fa fa-calendar fa-3x"></i></span>
                    <span class="title-note"><?php _e('Next', 'framework'); ?></span>
                    <strong><?php _e('Upcoming Event', 'framework'); ?></strong>
                </div>
                <div class="col-md-3 col-sm-6 col-6 notice-bar-event-title">
                    <?php
                    $specific_event_data = '';
                ...
                <div id="counter" class="col-md-4 col-sm-6 col-12 counter" data-date="<?php echo strtotime($firstEventDateData); ?>">
                ...
                if (!empty($imic_all_event_sermon_url) || !empty($pages_e[0]->ID)) {
                    ...
                    <div class="col-md-2 col-sm-6 d-none d-sm-block"> <a href="<?php echo esc_url($imic_all_event_sermon_url); ?>" class="btn btn-primary btn-lg btn-block"><?php _e('All Events', 'framework'); ?></a> </div>
                <?php } ?>
            </div>
        </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        foreach ($posts as $post) {
                            ...
                            if (!empty($attach_full_audio)) {
                                echo '<div class="col-md-7 col-sm-8 col-12">';
                ...
                <div class="listing">
                    <header class="listing-header">
                        ...
                        if (!empty($imic_custom_all_event_url) || !empty($pages_e[0]->ID)) {
                            ...
                            $imic_custom_all_event_url = !empty($imic_custom_all_event_url) ? $imic_custom_all_event_url : get_permalink($pages_e[0]->ID);
                            echo '<a href="' . $imic_custom_all_event_url . '" class="btn btn-primary float-end push-btn">' . esc_html__('All Events', 'framework') . '</a>';
                        }
                    ...
                    <div class="listing">
                        <header class="listing-header">
                            ...
                            if (!empty($imic_all_sermon_url) || !empty($pages_s_albums[0]->ID)) {
                                ...
                                echo '<a href="' . $imic_all_sermon_url . '" class="btn btn-primary float-end push-btn">' . esc_html__('All Albums', 'framework') . '</a>';
                            }
