...
<div class="container">
    <div class="row main-content-row">
     <div class="col-md-<?php echo esc_attr($class); ?> sermon-archive" id="content-col"> 
            <!-- Sermons Listing -->
            <article class="post sermon">
                <header class="post-title">
                    <h2><?php esc_html_e('Error 404 - Not Found', 'framework') ?></h2>
                    <div class="breaker"><span class="left"></span><div class="icon"></div><span class="right"></span></div>
                </header>
                <section class="entry">
                    <p><?php esc_html_e("Sorry, but you are looking for something that isn't here.", "framework") ?></p>
                </section>
            </article>
        </div>
        <!-- Start Sidebar -->
