...
if(!class_exists('Elementor_Eventer_Widget')){
	class Elementor_Eventer_Widget extends \Elementor\Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'Eventer', 'eventer' );
		}
		...
		public function get_keywords() {
			return [ 'eventer', 'event', 'events', 'calendar' ];
		}
		// Enqueue plugin styles
		public function get_style_depends() {
			return ['eventer_ui_css', 'eventer-style', 'eventer-line-icons'];
		}
		...
		protected function register_controls() {
			...
			$arr[''] = __( 'Next Upcoming Event', 'eventer' );
			...
			$event_organiser[''] = __( 'All', 'eventer' );
			...
			$this->start_controls_section(
				'content_section',
				[
					'label' => esc_html__( 'Shortcode Type', 'eventer' ),
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						'eventer_counter'  => esc_html__( 'Upcoming Event Countdown', 'eventer' ),
						'eventer_list'  => esc_html__( 'Events List', 'eventer' ),
						'eventer_grid'  => esc_html__( 'Events Grid', 'eventer' ),
						'eventer_slider'  => esc_html__( 'Events Slider', 'eventer' ),
						'eventer_calendar'  => esc_html__( 'Events Calendar', 'eventer' ),
					],
				]
			);
			...
			$this->start_controls_section(
				'counter_fields',
				[
					'label' => esc_html__( 'Countdown Shortcode', 'eventer' ),
					'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
					'condition' => [
			...
			$this->add_control(
				'counter_ids',
				[
					'label' => esc_html__( 'Select Event', 'eventer' ),
					'description' => esc_html__( 'You can select a specific event to show at the upcoming event counter.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => $arr,
				]
			);
			...
			$this->add_control(
				'counter_terms_cats',
				[
					'label' => esc_html__( 'Select Event Category', 'eventer' ),
					'description' => esc_html__( 'Select event categories from which events will be used in the upcoming event counter.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => $event_cat,
				]
			);
			...
			$this->add_control(
				'counter_terms_tags',
				[
					'label' => esc_html__( 'Select Event Tag', 'eventer' ),
					'description' => esc_html__( 'Select event tags, from which events will be used in the upcoming event counter.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => $event_tag,
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Select Event Venue', 'eventer' ),
					'description' => esc_html__( 'Select event venues, from which events will be used in the upcoming event counter.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => $event_venue,
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Select Event Organiser', 'eventer' ),
					'description' => esc_html__( 'Select event organisers, from which events will be used in the upcoming event counter.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
			...
			$this->add_control(
				'counter_venue',
				[
					'label' => esc_html__( 'Show Event Venue?', 'eventer' ),
			...
			$this->add_control(
				'counter_type',
				[
					'label' => esc_html__( 'Event Type', 'eventer' ),
			...
			$this->add_control(
				'counter_event_until',
				[
					'label' => esc_html__( 'Show Counter Till', 'eventer' ),
			...
			$this->start_controls_section(
				'list_fields',
				[
					'label' => esc_html__( 'List Shortcode', 'eventer' ),
					'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
					'condition' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Select Event', 'eventer' ),
					'description' => esc_html__( 'You can select specific events to show in the list. You can use ctrl/command key to select/deselect multiple values.', 'eventer' ),
			...
			$this->add_control(
				'list_terms_cats',
				[
					'label' => esc_html__( 'Event Category/s', 'eventer' ),
					'description' => esc_html__( 'Select event category, from which you want to show events specifically. You can use ctrl/command key to select/deselect multiple values.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT2,
					'options' => $event_cat,
					'multiple' => true,
				]
			...
			$this->add_control(
				'list_terms_tags',
				[
					'label' => esc_html__( 'Event Tag/s', 'eventer' ),
					'description' => esc_html__( 'Select event tags, from which you want to show events specifically. You can use ctrl/command key to select/deselect multiple values.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT2,
					'options' => $event_tag,
					'multiple' => true,
				]
			...
			$this->add_control(
				'list_terms_venues',
				[
					'label' => esc_html__( 'Event Venue/s', 'eventer' ),
					'description' => esc_html__( 'Select event venues, from which you want to show events specifically. You can use ctrl/command key to select/deselect multiple values.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT2,
					'options' => $event_venue,
					'multiple' => true,
				]
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Event Organiser/s', 'eventer' ),
					'description' => esc_html__( 'Select event organisers, from which you want to show events specifically. You can use ctrl/command key to select/deselect multiple values.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT2,
					'options' => $event_organiser,
					'multiple' => true,
				]
			...
			$this->add_control(
				'list_featured',
				[
					'label' => esc_html__( 'Featured Events', 'eventer' ),
					'description' => esc_html__( 'Select yes to show featured events at the top of list view.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
			...
			$this->add_control(
				'list_month_filter',
				[
					'label' => esc_html__( 'Filter Bar', 'eventer' ),
			...
			$this->add_control(
				'list_calview',
				[
					'label' => esc_html__( 'Filter Views', 'eventer' ),
					'description' => esc_html__( 'Select the calendar view tabs of the events to show in the list.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT2,
					'options' => [
			...
			$this->add_control(
				'list_status',
				[
					'label' => esc_html__( 'Event Status', 'eventer' ),
					'description' => esc_html__( 'Select the status of the events to show in the list.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
			...
			$this->add_control(
				'list_filters',
				[
					'label' => esc_html__( 'Taxonomy Filters', 'eventer' ),
					'description' => esc_html__( 'Select filters for the custom taxonomies of the events.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT2,
					'options' => [
						'category'  => esc_html__( 'Categories', 'eventer' ),
						'tag'  => esc_html__( 'Tags', 'eventer' ),
						'venue'  => esc_html__( 'Venues', 'eventer' ),
						'organizer'  => esc_html__( 'Organisers', 'eventer' ),
					],
					'default' => '',
					'multiple' => true,
					'condition' => [
			...
			$this->add_control(
				'list_view',
				[
					'label' => esc_html__( 'List Style', 'eventer' ),
			...
			$this->add_control(
				'list_venue',
				[
					'label' => esc_html__( 'Show Venue?', 'eventer' ),
			...
			$this->add_control(
				'list_count',
				[
					'label' => esc_html__( 'Events Per Page', 'eventer' ),
					'description' => esc_html__( 'Enter number of events to show per page when event month filter is shown.', 'eventer' ),
			...
			$this->add_control(
				'list_pagination',
				[
					'label' => esc_html__( 'Show Pagination?', 'eventer' ),
			...
			$this->start_controls_section(
				'grid_fields',
				[
					'label' => esc_html__( 'Grid Shortcode', 'eventer' ),
					'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
					'condition' => [
			...
			$this->add_control(
				'grid_layout',
				[
					'label' => esc_html__( 'Grid Style', 'eventer' ),
					'description' => esc_html__( 'Select the layout for grid view.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Select Event', 'eventer' ),
					'description' => esc_html__( 'You can select specific events to show in the grid. You can use ctrl/command key to select/deselect multiple values.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT2,
					'options' => $arr,
					'multiple' => true,
				]
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Event Type', 'eventer' ),
					'description' => esc_html__( 'Select event type for the grid. You can choose All to show both WordPress and Google Calendar events in the grid or WP/Google to show selected events only.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						''  => esc_html__( 'All', 'eventer' ),
						'1'  => esc_html__( 'WP', 'eventer' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Featured Events', 'eventer' ),
					'description' => esc_html__( 'Select yes to show featured events at the top of grid view.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						''  => esc_html__( 'No', 'eventer' ),
						'1'  => esc_html__( 'Yes', 'eventer' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Filter Views', 'eventer' ),
					'description' => esc_html__( 'Select the calendar view tabs of the events to show in the grid, this will not work with the status of future or past.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT2,
					'options' => [
						'yearly'  => esc_html__( 'Year View', 'eventer' ),
						'monthly'  => esc_html__( 'Month View', 'eventer' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Event Status', 'eventer' ),
					'description' => esc_html__( 'Select the status of the events to show in the grid.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						''  => esc_html__( 'Future', 'eventer' ),
						'past'  => esc_html__( 'Past', 'eventer' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Show Venue?', 'eventer' ),
					'description' => esc_html__( 'Select Yes to show event venue address for every event in the grid.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						''  => esc_html__( 'Yes(Show full address)', 'eventer' ),
						'name'  => esc_html__( 'Yes(Show venue name)', 'eventer' ),
			...
			$this->add_control(
				'grid_background',
				[
					'label' => esc_html__( 'Grid Events Background', 'eventer' ),
			...
			$this->add_control(
				'grid_column',
				[
					'label' => esc_html__( 'Grid Columns', 'eventer' ),
					'description' => esc_html__( 'Select columns for the grid.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						'3'  => esc_html__( 'Default (3 Columns)', 'eventer' ),
						'1'  => esc_html__( '1 Column', 'eventer' ),
						'2'  => esc_html__( '2 Columns', 'eventer' ),
						'4'  => esc_html__( '4 Columns', 'eventer' ),
					],
					'default' => '3'
				]
			);
			...
			$this->add_control(
				'carousel_autoplay',
				[
					'label' => esc_html__( 'Autoplay Carousel?', 'eventer' ),
					'description' => esc_html__( 'Select Yes to autoplay carousel.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						'yes'  => esc_html__( 'Yes', 'eventer' ),
						'no'  => esc_html__( 'No', 'eventer' ),
			...
			$this->add_control(
				'carousel_interval',
				[
					'label' => esc_html__( 'Autoplay Timeout', 'eventer' ),
					'description' => esc_html__( 'Enter value for after how many seconds carousel should auto move to next slide.', 'eventer' ),
			...
			$this->add_control(
				'carousel_pagination',
				[
					'label' => esc_html__( 'Show Carousel Pagination?', 'eventer' ),
					'description' => esc_html__( 'Select Yes to display pagination dots with the carousel.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						'yes'  => esc_html__( 'Yes', 'eventer' ),
						'no'  => esc_html__( 'No', 'eventer' ),
			...
			$this->add_control(
				'carousel_arrows',
				[
					'label' => esc_html__( 'Show Carousel Arrows?', 'eventer' ),
					'description' => esc_html__( 'Select Yes to display navigation arrows with the carousel.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						'yes'  => esc_html__( 'Yes', 'eventer' ),
						'no'  => esc_html__( 'No', 'eventer' ),
			...
			$this->add_control(
				'carousel_rtl',
				[
					'label' => esc_html__( 'RTL Carousel?', 'eventer' ),
					'description' => esc_html__( 'Select Yes if your website is for the RTL language.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						'yes'  => esc_html__( 'Yes', 'eventer' ),
						'no'  => esc_html__( 'No', 'eventer' ),
			...
			$this->start_controls_section(
				'slider_fields',
				[
					'label' => esc_html__( 'Slider Shortcode', 'eventer' ),
					'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
					'condition' => [
			...
			$this->add_control(
				'slider_layout',
				[
					'label' => esc_html__( 'Slider Style', 'eventer' ),
					'description' => esc_html__( 'Select the layout for slider view.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						''  => esc_html__( 'Style 1', 'eventer' ),
						'type2'  => esc_html__( 'Style 2', 'eventer' ),
						'type3'  => esc_html__( 'Style 3', 'eventer' ),
					],
					'default' => ''
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Select Event', 'eventer' ),
					'description' => esc_html__( 'You can select specific events to show in the slider. You can use ctrl/command key to select/deselect multiple values.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT2,
					'options' => $arr,
					'multiple' => true,
				]
			...
			$this->add_control(
				'slider_count',
				[
					'label' => esc_html__( 'No. of Slides', 'eventer' ),
					'description' => esc_html__( 'Enter the number of how many slides you would like to show in the slider.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::NUMBER,
					'min' => 1,
					'max' => 50,
					'default' => 1,
			...
			$this->add_control(
				'slider_autoplay',
				[
					'label' => esc_html__( 'Autoplay Slider?', 'eventer' ),
					'description' => esc_html__( 'Select Yes to autoplay slider.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						'yes'  => esc_html__( 'Yes', 'eventer' ),
						'no'  => esc_html__( 'No', 'eventer' ),
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Autoplay Timeout', 'eventer' ),
					'description' => esc_html__( 'Enter value for after how many seconds slider should auto move to next slide.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::TEXT,
					'default' => '4000',
					'condition' => [
						'slider_autoplay' => 'yes'
			...
			$this->add_control(
				'slider_pagination',
				[
					'label' => esc_html__( 'Show Slider Pagination?', 'eventer' ),
					'description' => esc_html__( 'Select Yes to display pagination dots with the slider.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						'yes'  => esc_html__( 'Yes', 'eventer' ),
						'no'  => esc_html__( 'No', 'eventer' ),
			...
			$this->add_control(
				'slider_arrows',
				[
					'label' => esc_html__( 'Show Slider Arrows?', 'eventer' ),
					'description' => esc_html__( 'Select Yes to display navigation arrows with the slider.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						'yes'  => esc_html__( 'Yes', 'eventer' ),
						'no'  => esc_html__( 'No', 'eventer' ),
			...
			$this->add_control(
				'slider_rtl',
				[
					'label' => esc_html__( 'RTL Slider?', 'eventer' ),
					'description' => esc_html__( 'Select Yes if your website is for the RTL language.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						'yes'  => esc_html__( 'Yes', 'eventer' ),
			...
			$this->start_controls_section(
				'calendar_fields',
				[
					'label' => esc_html__( 'Calendar Shortcode', 'eventer' ),
					'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
					'condition' => [
			...
			$this->add_control(
				'calendar_preview',
				[
					'label' => esc_html__( 'Event Preview', 'eventer' ),
					'description' => esc_html__( 'Select Yes to enable event details preview when hovered over the events on the calendar.', 'eventer' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						''  => esc_html__( 'Yes', 'eventer' ),
						'no'  => esc_html__( 'No', 'eventer' ),
