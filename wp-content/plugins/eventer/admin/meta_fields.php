...
function eventer_show_meta_box()
{
  ...
  foreach ($meta_box['fields'] as $field) {
    ...
    echo '<tr class="' . $field['class'] . 'eventer-field_' . $field['type'] . '">',
    ...
    switch ($field['type']) {
      case 'text':
        ...
        break;
      case 'hidden':
        echo '<input maxlength="' . $field['limit'] . '" type="hidden" name="', $field['id'], '" id="', $field['id'], '" value="', $field['std'], '" size="30" style="width:97%" />', '<span class="field-description">' . $field['desc'] . '</span>';
        break;
      case 'textarea':
...
function eventer_create_details_metabox($meta_box = array())
{
  ...
  $meta_box = array(
    ...
    'fields' => array(
      ...
      array(
        'name' => esc_html__('Event Start Date Only - Hidden Value', 'eventer'),
        'desc' => '',
        'id' => $prefix . 'event_start_dt_donly',
        'class' => '',
        'limit' => '',
        'type' => 'hidden',
        'std' => date_i18n('Ymd', strtotime(get_post_meta(get_the_ID(), 'eventer_event_start_dt', true)))
      ),
      array(
        'name' => esc_html__('Event Start Weekday - Hidden Value', 'eventer'),
        'desc' => '',
        'id' => $prefix . 'event_start_dt_wday',
        'class' => '',
        'limit' => '',
        'type' => 'hidden',
        'std' => date_i18n('l', strtotime(get_post_meta(get_the_ID(), 'eventer_event_start_dt', true)))
      ),
      array(
        'name' => esc_html__('Event Start Day - Hidden Value', 'eventer'),
        'desc' => '',
        'id' => $prefix . 'event_start_dt_day',
        'class' => '',
        'limit' => '',
        'type' => 'hidden',
        'std' => date_i18n('d', strtotime(get_post_meta(get_the_ID(), 'eventer_event_start_dt', true)))
      ),
      array(
        'name' => esc_html__('Event Start Month - Hidden Value', 'eventer'),
        'desc' => '',
        'id' => $prefix . 'event_start_dt_month',
        'class' => '',
        'limit' => '',
        'type' => 'hidden',
        'std' => date_i18n('F', strtotime(get_post_meta(get_the_ID(), 'eventer_event_start_dt', true)))
      ),
      array(
        'name' => esc_html__('Event Start Year - Hidden Value', 'eventer'),
        'desc' => '',
        'id' => $prefix . 'event_start_dt_year',
        'class' => '',
        'limit' => '',
        'type' => 'hidden',
        'std' => date_i18n('Y', strtotime(get_post_meta(get_the_ID(), 'eventer_event_start_dt', true)))
      ),
      array(
        'name' => esc_html__('Event Start Time - Hidden Value', 'eventer'),
        'desc' => '',
        'id' => $prefix . 'event_start_dt_time',
        'class' => '',
        'limit' => '',
        'type' => 'hidden',
        'std' => date_i18n('g:i a', strtotime(get_post_meta(get_the_ID(), 'eventer_event_start_dt', true)))
      ),
      array(
      ...
      array(
        'name' => esc_html__('Event End Weekday - Hidden Value', 'eventer'),
        'desc' => '',
        'id' => $prefix . 'event_end_dt_wday',
        'class' => '',
        'limit' => '',
        'type' => 'hidden',
        'std' => date_i18n('l', strtotime(get_post_meta(get_the_ID(), 'eventer_event_end_dt', true)))
      ),
      array(
        'name' => esc_html__('Event End Day - Hidden Value', 'eventer'),
        'desc' => '',
        'id' => $prefix . 'event_end_dt_day',
        'class' => '',
        'limit' => '',
        'type' => 'hidden',
        'std' => date_i18n('d', strtotime(get_post_meta(get_the_ID(), 'eventer_event_end_dt', true)))
      ),
      array(
        'name' => esc_html__('Event End Month - Hidden Value', 'eventer'),
        'desc' => '',
        'id' => $prefix . 'event_end_dt_month',
        'class' => '',
        'limit' => '',
        'type' => 'hidden',
        'std' => date_i18n('F', strtotime(get_post_meta(get_the_ID(), 'eventer_event_end_dt', true)))
      ),
      array(
        'name' => esc_html__('Event End Year - Hidden Value', 'eventer'),
        'desc' => '',
        'id' => $prefix . 'event_end_dt_year',
        'class' => '',
        'limit' => '',
        'type' => 'hidden',
        'std' => date_i18n('Y', strtotime(get_post_meta(get_the_ID(), 'eventer_event_end_dt', true)))
      ),
      array(
        'name' => esc_html__('Event End Time - Hidden Value', 'eventer'),
        'desc' => '',
        'id' => $prefix . 'event_end_dt_time',
        'class' => '',
        'limit' => '',
        'type' => 'hidden',
        'std' => date_i18n('g:i a', strtotime(get_post_meta(get_the_ID(), 'eventer_event_end_dt', true)))
      ),
      array(
      ...
      array(
        'name' => esc_html__('Virtual Event', 'eventer'),
        'desc' => esc_html__('Check this if you want to make this event as Virtual.', 'eventer'),
        'id' => $prefix . 'event_virtual',
        'class' => 'bordered',
        'type' => 'checkbox'
      ),
      array(
      ...
      array(
        'name' => esc_html__('Additional Meta', 'eventer'),
        'desc' => esc_html__('Enter the additional meta info for the event, this will show in meta section of event details page.', 'eventer'),
      ...
      array(
        ...
        'desc' => esc_html__('If you want to repeat this event for a selected period then select the type of recurrence. Select "Fixed date" to repeat it every day or every second day etc. or every week/month. Select "Week Day" to repeat the event on a weekday like Sunday, Monday etc.', 'eventer'),
      ...
      array(
        ...
        'desc' => esc_html__('Select which week of the month you want to repeat this event or use as week span(weekly repeat) by checking below checkbox.', 'eventer'),
      ...
      array(
        ...
        'options' => array(
          ...
          '365' => esc_html__('Every Year', 'eventer')
        )
      ),
      array(
      ...
      array(
        ...
        'desc' => esc_html__('Insert URL here if you want the event to redirect to another link.', 'eventer'),
      ...
      array(
        ...
        'desc' => esc_html__('Select custom permalink target. If you want to redierct users to a custom URL in a new window/tab then select Blank. To open it on the same page select Self.', 'eventer'),
      ...
      array(
        'name' => esc_html__('Grid Button', 'eventer'),
        'desc' => esc_html__('Insert text here to add a read more button in the grid view(where applicable).', 'eventer'),
      ...
      array(
        'name' => esc_html__('Individual Registrants', 'eventer'),
        'desc' => esc_html__('Insert shortcodes of Individual Registrants fields here if you would like to have different forms for each event, default form will work from settings field only.', 'eventer'),
        'id' => $prefix . 'event_individual_registrants_fields',
        'class' => '',
        'limit' => '',
        'type' => 'textarea',
        'std' => ''
      ...
      array(
        'name' => esc_html__('Event Status', 'eventer'),
        'desc' => esc_html__('Select status os the event which will be displayed with the event name in list/grid.', 'eventer'),
        'id' => $prefix . 'event_custom_status',
        'class' => '',
        'type' => 'select',
        'options' => array(
      ...
      array(
        ...
        'desc' => esc_html__('Insert shortcodes of registration form fields here if you would like to have different forms for each event, default form will work from settings field only. This area will not work for the Woocommerce payment system.', 'eventer'),
      ...
      array(
        ...
        'desc' => esc_html__('Insert a valid URL here, if you want the register/booking button to redirect to some other URL instead of opening the booking form. Like, if you want to redirect users to your event on Eventbrite website.', 'eventer'),
      ...
      array(
        ...
        'desc' => esc_html__('If you want to open the custom registration URL in a new window/tab then select Blank. To open it on same page select Self.', 'eventer'),
      ...
      array(
        'name' => esc_html__('Additional info for the email templates', 'eventer'),
        'desc' => esc_html__('Enter the additional info to show in the email templates. Use {event_additional_info} shortcode in the email template fields.', 'eventer'),
      ...
      array(
        'name' => esc_html__('Do not email tickets', 'eventer'),
        'desc' => esc_html__('Check this option, if you would like to stop sending email with tickets for this event.', 'eventer'),
        'id' => $prefix . 'event_ticket_email',
        'class' => 'bordered',
        'type' => 'checkbox'
      ),
      array(
        'name' => esc_html__('Instructions for ticket', 'eventer'),
        'desc' => esc_html__('Enter optional instructions to show on the ticket', 'eventer'),
        'id' => $prefix . 'event_ticket_image_notes',
        'class' => '',
        'limit' => '',
        'type' => 'textarea',
        'std' => ''
      ...
      array(
        'name' => esc_html__('Instructions for the PDF Invoice', 'eventer'),
        'desc' => esc_html__('Enter optional instructions to show at the bottom of the PDF invoices. PDF invoice works with only default payments but not with Woocommerce.', 'eventer'),
        'id' => $prefix . 'event_ticket_pdf_notes',
        'class' => '',
        'limit' => '',
        'type' => 'textarea',
        'std' => ''
...
{ ?>
  ...
  {
    add_meta_box('eventer-time-slot', esc_html__('Time Slot', 'eventer'), 'eventer_time_slots', 'eventer', 'normal', 'core');
  }
  /**
  ...
  function eventer_time_slots()
  {
    ...
    <div class="eventer-time-slot-sections">
      ...
      <div class="eventer-metabox-section">
      	<table>
	      	<tr valign="top">
	          <th scope="row"><?php esc_html_e('Mandatory Time Slot', 'eventer'); ?></th>
	          <td colspan="3">
	          	<?php $value = get_post_meta( $post->ID, 'eventer_time_slots_mandatory', true );?>
	            <input type="radio" name="eventer_time_slots_mandatory" value="on" <?php checked($value, 'on'); ?>> <?php esc_html_e('Yes', 'eventer'); ?>
	            <input type="radio" name="eventer_time_slots_mandatory" value="off" <?php checked($value, 'off'); ?>> <?php esc_html_e('No', 'eventer'); ?>
	            <p class="description"><?php esc_html_e('Make Time Slot field mandatory while booking for ticket.'); ?></p>
	          </td>
	        </tr>
	    </table>
      </div>
    ...
    function eventer_update_time_slot($post_id, $post_object)
    {
      ...
      if ( isset( $_POST['eventer_time_slots_mandatory'] ) ) {
      	update_post_meta( $post_id, 'eventer_time_slots_mandatory', $_POST['eventer_time_slots_mandatory'] );
      }
    ...
    function eventer_event_tickets_output()
    {
      ...
      <div class="eventer-form-table">
        <table class="eventer-normal-tickets-table eventer-metabox">
          ...
          <?php
              for ($field = 0; $field < $tickets_count; $field++) {
                ...
                $optional_available_tickets = get_post_meta($post->ID, 'eventer_event_available_tickets', true);
                $available_tickets_checked = ($optional_available_tickets == 'yes') ? 'checked' : '';
                ?>
        ...
        <div id="add_field_row" class="eventer-metabox-section">
          ...
          <label class="eventer-metabox-field"><input type="checkbox" name="eventer-admin-available-tickets" <?php echo esc_attr($available_tickets_checked); ?> value="yes" /> <?php esc_html_e('Hide Available Tickets.', 'eventer'); ?></label>
          ...
          <table class="eventer-metabox">
            ...
            <?php
              ...
              <tr class="booked_eventer_section">
                ...
                <td><label><input class="meta_sch_title booked_record_event_restrict booked_fields" value="1" type="checkbox"></label></td>
    ...
    function eventer_update_event_tickets_data($post_id, $post_object)
    {
      ...
      if (isset($_POST['eventer_ticket_type'])) {
        ...
        $tickets_available = (isset($_POST['eventer-admin-available-tickets']) && $_POST['eventer-admin-available-tickets'] == 'yes') ? 'yes' : '';
        update_post_meta($post_id, 'eventer_event_available_tickets', $tickets_available);
      }
    }


    if (isset($_REQUEST['taxonomy'])) :
      $taxonomy = 'eventer-organizer';
      if (!function_exists('eventer_organizer_image_field')) :
        add_action($taxonomy . '_add_form_fields', 'eventer_organizer_image_field', 10, 2);
        add_action($taxonomy . '_edit_form_fields', 'eventer_organizer_image_field', 10, 2);
        function eventer_organizer_image_field($tag)
        {
          if (is_object($tag)) {
            $organizer_id = $tag->term_id; // Get the ID of the term we're editing
            $term_meta = get_term_meta($organizer_id, 'organizer_image', true);
            $image_src = wp_get_attachment_image_src($term_meta);
        ...
        <table class="form-table">
          <tbody>
            <tr class="form-field form-required">
              <th scope="row"><label for="image"><?php esc_html_e('Organizer Image', 'eventer') ?></label></th>
              <td><?php
                        echo '<div><img id="eventer_organizer_image" src ="' . esc_url($image) . '" width ="150px" height ="150px"/></div>';
                        echo '<input id="eventer_upload_organizer_image" type="button" class="button button-primary" value="' . esc_html__('Upload Image', 'eventer') . '" /> ';
                        if (isset($tag->term_id)) {
                          echo '<input id="eventer_organizer_image_remove" type="button" class="button button-primary" value="' . esc_html__('Remove Image', 'eventer') . '" />';
                        }
                        ?>
                <p class="description"><?php esc_html_e('Upload organizer image.', 'eventer'); ?></p>
              </td>
            </tr><input type="hidden" id="organizer_image_id" name="eventer_organizer_id_save" value="<?php echo $term_meta; ?>" />
          </tbody>
        </table>
  <?php
      }
    endif;
    if (!function_exists('eventer_organizer_save_image_custom_fields')) :
      add_action('created_' . $taxonomy, 'eventer_organizer_save_image_custom_fields');
      add_action('edited_' . $taxonomy, 'eventer_organizer_save_image_custom_fields', 10, 1);
      function eventer_organizer_save_image_custom_fields($term_id)
      {
        if (isset($_POST['eventer_organizer_id_save'])) {
          $organizer_image = $_POST['eventer_organizer_id_save'];
          update_term_meta($term_id, 'organizer_image', $organizer_image);
        }
      }
    endif;
  endif;
