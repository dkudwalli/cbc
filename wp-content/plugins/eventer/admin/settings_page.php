...
if ($woocommerce_ticketing == "on") {
  include_once(EVENTER__PLUGIN_PATH . '/registration/include.php');
}
// Start Class
if (!class_exists('Eventer_Settings_Options')) {
  ...
  class Eventer_Settings_Options
  {
    ...
    public static function eventer_create_ticket_details_table()
    {
	  ...
	  $ticketsMeta = $wpdb->prefix . "eventer_default_ticket_meta";
      ...
      if ($wpdb->get_var("SHOW TABLES LIKE '$table_name_tickets'") != $table_name_tickets) {
		...
		if ($wpdb->get_var("SHOW TABLES LIKE '$ticketsMeta'") != $ticketsMeta) {
			$charset_collate = $wpdb->get_charset_collate();
			$sql = "CREATE TABLE $ticketsMeta (
				id bigint(90) NOT NULL AUTO_INCREMENT,
				reg_id bigint(90) NOT NULL,
    ...
    {
      $settings_val = array('eventer_paypal_payment_type' => '0', 'eventer_paypal_business_email' => '', 'eventer_paypal_currency' => 'AUD', 'eventer_offline_payment_switch' => '1', 'eventer_offline_payment_desc' => 'Bank Name<br>Account No: 0000 1400 1211<br>IFSC Code: 00001321<br>Branch Address', 'event_default_color' => '#595fde', 'eventer_enable_categories' => 'on', 'eventer_enable_tags' => 'on', 'eventer_enable_venue' => 'on', 'eventer_enable_organizer' => 'on', 'eventer_show_single_occurance' => 'off', 'eventer_recurring_icon_yes' => 'on', 'eventer_save_options' => 'on', 'eventer_event_schema' => 'on', 'eventer_save_event' => 'off', 'eventer_google_font_global' => 'Oswald', 'start_time_format' => 'l, g:i A', 'time_separator' => 'to', 'end_time_format' => 'g:i A', 'eventer_date_format_single' => 'Y-m-d','eventer_date_format' => 'Y-m-d G:i', 'eventer_calendar_view' => 'month', 'eventer_calendar_header_left_view' => 'title', 'eventer_calendar_header_center_view' => '', 'eventer_calendar_header_right_view' => 'today prev,next', 'eventer_calendar_rtl' => '0', 'eventer_calendar_start_today' => '0', 'event_limit' => '100', 'google_apikey' => '', 'google_cal_apikey' => '', 'cal_id' => '', 'payment_confirmation_content' => '<h3>Payment verification Details</h3><p>Registrant ID: {reg_id}</p><p>Transaction ID: {tx_id}</p><p>Registrant Email: {reg_email}</p><p>Amount Paid: {amt_pd}</p><p>Status: {pmt_st}</p><p>Tickets: {tkt}</p><p>Event: {evt_url}</p>{user_details}[eventer_free data="<p>Thanks for registration.</p>"][eventer_offline data="<p>This is bank details.</p>"][eventer_paid data="<p>Thanks for the payment.</p>"][eventer_tkturl completed="1" pending="1" failed="1"]<p>We welcomes you for the Event.</p>', 'pre_registration_content' => '<h3>Pre Registration Details</h3><p>Registrant ID: {reg_id}</p><p>Registrant Email: {reg_email}</p><p>Amount Paid: {amt_pd}</p><p>Tickets: {tkt}</p><p>Event: {evt_url}</p>{user_details}', 'ticket_booking_fields' => '[eventer_field_row][eventer_field_halfcol]
...
[eventer_fields type="email" text_row="4" required="yes" class="" id="" param="" name="YOUR EMAIL" label="YOUR EMAIL"][eventer_fields type="number" text_row="4" required="no" class="" id="" param="" name="YOUR PHONE" label="YOUR PHONE"][eventer_fields type="checkbox" text_row="4" required="no" class="" id="" param="1,2,{3},4" name="" label="Food Choice"][eventer_fields type="textarea" text_row="4" required="no" class="" id="" param="" name="YOUR MESSAGE" label="YOUR MESSAGE"]', 'eventer_category_view' => '4', 'eventer_category_sidebar' => '', 'eventer_venues_view' => '2', 'eventer_venue_sidebar' => '', 'eventer_organizer_view' => '3', 'eventer_organizer_sidebar' => '', 'eventer_tag_view' => '4', 'eventer_tag_sidebar' => '', 'eventer_archive_view' => '5', 'eventer_archive_sidebar' => '', 'eventer_search_view' => '1', 'eventer_search_sidebar' => '', 'eventer_event_permalink' => '', 'eventer_event_category_permalink' => '', 'eventer_event_tag_permalink' => '', 'eventer_event_venue_permalink' => '', 'eventer_event_organizer_permalink' => '', 'eventer_pdf_ticket' => 'on');
     ...
     * @since 1.0.0
     */
    public static function get_eventer_option($id, $default = '' )
    {
    ...
    public static function add_bookings_menu()
    {
		...
		// Check if the setting is not set or not set to 'on'
		if (!$woocommerce_ticketing_enabled || $woocommerce_ticketing_enabled !== 'on') {
		  add_submenu_page(
      ...
      foreach ($sb as $key => $value) {
        if (array_key_exists($key, $options)) {
          ...
          if (is_array($value)) {
            ...
            if ($key == "payment_confirmation_content" || $key == "pre_registration_content" || $key == "contact_organizer_fields" || $key == "ticket_booking_fields" || $key == "individual_registrant_fields" || $key == "add_new_event_content" || $key == "add_new_event_published") {
              $options[$key] = $value;
            } else {
    ...
    { ?>
      ...
      <div class="wrap">
        ...
        <?php
          ...
          <a href="edit.php?post_type=eventer&page=eventer_settings_options&amp;tab=design" class="nav-tab <?php echo ($active_tab == 'design') ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Design', 'eventer'); ?></a>
		  <?php
           $woocommerce_ticketing = self::get_eventer_option('eventer_enable_woocommerce_ticketing');
           if ($woocommerce_ticketing != 'on') { ?>
        ...
        <form method="post" action="options.php">
                ...
                <div id="eventer-admin-sub-tabs-vertical">
                  <div id="eventer-admin-tab-container">
                    <ul>
                      ...
                      <li><a href="javascript:void(0)" data-tab="#ticket-images-settings" class="general-settings-tab"><?php esc_html_e('Tickets', 'eventer'); ?></a></li>
                      <li><a href="javascript:void(0)" data-tab="#ticket-pdf-settings" class="general-settings-tab"><?php esc_html_e('PDF Invoice', 'eventer'); ?></a></li>
                    </ul>
                  </div>
                  <div id="eventer-admin-main-container">
                    ...
                    <div class="general-settings eventer-admin-tab-content" id="common-settings">
                      <table class="form-table eventer-custom-admin-login-table">
                        <tr>
                          <th>
                            <?php esc_html_e('Check-In App API Key', 'eventer');
                                  $value_tab = self::get_eventer_option('event_general_tab');
                                  $value_tab = $value_tab ? $value_tab : '#common-settings'; ?>
                          </th>
                          <td>
                            <code><?php echo (int) get_option('eventer-android-app-api-key'); ?></code>
                          </td>
                        </tr>
                        <tr valign="top">
                        ...
                        <tr valign="top">
                          <th scope="row"><?php esc_html_e('Show event status badge', 'eventer'); ?></th>
                          <td colspan="3">
                            ...
                            <p class="description"><?php esc_html_e('Show event status Expired/Upcoming/Ongoing badge on the events list/grid/slider views.', 'eventer'); ?></p>
                          </td>
                        </tr>
                    ...
                    <div class="general-settings eventer-admin-tab-content" id="single-settings" style="display: none;">
                      <table class="form-table eventer-custom-admin-login-table">
                        ...
                        <tr valign="top">
                          <th scope="row"><?php esc_html_e('Calendar Type', 'eventer'); ?></th>
                          <td colspan="3">
                            <?php $value = self::get_eventer_option('eventer_booking_calendar_type'); ?>
                            <input type="radio" name="eventer_options[eventer_booking_calendar_type]" value="on" <?php checked($value, 'on'); ?>> <?php esc_html_e('Dropdown', 'eventer'); ?>
                            <input type="radio" name="eventer_options[eventer_booking_calendar_type]" value="off" <?php checked($value, 'off'); ?>> <?php esc_html_e('Calendar', 'eventer'); ?>
                            <p class="description"><?php esc_html_e('Show a select field of upcoming recurring dates instead of full calendar on details page.', 'eventer'); ?></p>
                          </td>
                        </tr>
                        ...
                        <tr valign="top">
                          <th scope="row"><?php esc_html_e('Mandatory Time slots', 'eventer'); ?></th>
                          <td colspan="3">
                            <?php $value = self::get_eventer_option('eventer_time_slots_mandatory'); ?>
                            <input type="radio" name="eventer_options[eventer_time_slots_mandatory]" value="on" <?php checked($value, 'on'); ?>> <?php esc_html_e('Yes', 'eventer'); ?>
                            <input type="radio" name="eventer_options[eventer_time_slots_mandatory]" value="off" <?php checked($value, 'off'); ?>> <?php esc_html_e('No', 'eventer'); ?>
                            <p class="description"><?php esc_html_e('Make time slot selection mandatory for ticket booking. You can override this setting for each event.'); ?></p>
                          </td>
                        </tr>
                        ...
                        <tr valign="top">
                          <th scope="row"><?php esc_html_e('Enable Event Schema', 'eventer'); ?></th>
                          <td colspan="3">
                            <?php $value = self::get_eventer_option('eventer_event_schema'); ?>
                            <input type="radio" name="eventer_options[eventer_event_schema]" value="on" <?php checked($value, 'on'); ?>> <?php esc_html_e('Yes', 'eventer'); ?>
                            <input type="radio" name="eventer_options[eventer_event_schema]" value="off" <?php checked($value, 'off'); ?>> <?php esc_html_e('No', 'eventer'); ?>
                            <p class="description"><?php esc_html_e('Select Yes to show schema on event single page.', 'eventer'); ?></p>
                          </td>
                        </tr>
                    ...
                    <div class="general-settings eventer-admin-tab-content" id="email-settings" style="display: none;">
                      <table class="form-table eventer-custom-admin-login-table">
                        <tr valign="top">
                            <th scope="row">
                                <?php esc_html_e('Send email from name', 'eventer'); ?>
                            </th>
                            <td colspan="3">
                                <?php $value = self::get_eventer_option('email_from_name', esc_attr( get_bloginfo( 'name', 'display' ) ) ); ?>
                                <input type="text" name="eventer_options[email_from_name]" value="<?php echo esc_attr($value); ?>">
                            	<p class="description"><?php esc_html_e('The name that emails are sent from.', 'eventer'); ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <?php esc_html_e('Send email from address', 'eventer'); ?>
                            </th>
                            <td colspan="3">
                                <?php $value = self::get_eventer_option('email_from_address', get_option( 'admin_email' )); ?>
                                <input type="text" name="eventer_options[email_from_address]" value="<?php echo esc_attr($value); ?>">
                            	<p class="description"><?php esc_html_e('The email address that emails are sent from.', 'eventer'); ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
                          <th scope="row">
                                <label for="image"><?php esc_html_e('Logo', 'eventer') ?></label>
                          </th>
                          <td colspan="3">
                                <?php
                                $value = self::get_eventer_option('email_template_logo' );
                                if ( $value ) {
                                ...
                                <p><img id="eventer_email_template_image" src ="<?php echo esc_url($image); ?>" width="150"/></p>
                                <input id="eventer_upload_email_template_image" type="button" class="button button-primary" value="<?php echo esc_html__('Upload Image', 'eventer'); ?>" />
                                <input id="eventer_email_template_image_remove" type="button" class="button button-primary" value="<?php echo esc_html__('Remove Image', 'eventer') ; ?>" />
                                <input type="hidden" id="eventer_email_template_image_id" name="eventer_options[email_template_logo]" value="<?php echo $value; ?>" />
							  	<p class="description"><?php esc_html_e('Logo image for the email templates. Best image width should not be more than 250px with variable height.', 'eventer'); ?></p>
                          </td>
                        </tr>
						<tr valign="top">
						  <th scope="row"><?php esc_html_e('Footer Text', 'eventer'); ?></th>
						  <td colspan="3">
							<?php $value = self::get_eventer_option('email_footer_text'); ?>
							<?php wp_editor($value, 'email_footer_text', array('textarea_name' => 'eventer_options[email_footer_text]')); ?>
							<p class="description"><?php esc_html_e('Enter text/html to show in the email templates footer.', 'eventer'); ?></p>
						  </td>
						</tr>
						<tr>
							<td colspan="2">
                        ...
                        <tr valign="top">
                          ...
                          <td colspan="3">
                            ...
                            <p>
                              ...
                              <code>{services}</code> -> <?php esc_html_e('Selected additional services', 'eventer'); ?><br>
                        ...
                        <tr valign="top">
                          ...
                          <td colspan="3">
                            ...
                            <!--<p>                                                                                                                                                                                                         <code>{reg_id}</code> -> <?php esc_html_e('Registrant ID', 'eventer'); ?><br>                                                                                                                               <code>{reg_email}</code> -> <?php esc_html_e('Registrant Email', 'eventer'); ?><br>                                                                                                                         <code>{tx_id}</code> -> <?php esc_html_e('Transaction ID', 'eventer'); ?><br>                                                                                                                               <code>{pmt_st}</code> -> <?php esc_html_e('Payment Status', 'eventer'); ?><br>                                                                                                                              <code>{amt_pd}</code> -> <?php esc_html_e('Amount Paid', 'eventer'); ?><br>                                                                                                                                 <code>{evt_url}</code> -> <?php esc_html_e('Event URL', 'eventer'); ?><br>                                                                                                                                  <code>{tkt}</code> -> <?php esc_html_e('Tickets Info', 'eventer'); ?><br>                                                                                                                                   <code>{user_details}</code> -> <?php esc_html_e('Registrant personal details', 'eventer'); ?><br>                                                                                                       </p>-->
                          </td>
                        </tr>

                        <tr valign="top">
                          <th scope="row"><?php esc_html_e('Invoice', 'eventer'); ?><br />
                            <?php $value = self::get_eventer_option('email_pdf_invoice'); ?>
                            <input type="radio" name="eventer_options[email_pdf_invoice]" value="1" <?php checked($value, "1"); ?>> <?php esc_html_e('Enable', 'eventer'); ?>
                            <input type="radio" name="eventer_options[email_pdf_invoice]" value="0" <?php checked($value, "0"); ?>> <?php esc_html_e('Disable', 'eventer'); ?></th>
                          <td colspan="3">
                            <?php $value = self::get_eventer_option('email_pdf_invoices_body'); ?>
                            <?php wp_editor($value, 'email_pdf_invoices_body', array('textarea_name' => 'eventer_options[email_pdf_invoices_body]')); ?>
                            <p class="description notice notice-warning"><?php esc_html_e('Please be noted that PDF Invoicing works only with the default payment options but not with Woocommerce. For Woocommerce use any of the free PDF invoices plugin ex. PDF Invoices & Packing Slips for WooCommerce.', 'eventer'); ?></p>
                            <p class="description"><?php esc_html_e('Enter content(Text/HTML) for the email which is sent to users with atatched PDF invoice.', 'eventer'); ?></p>
                          </td>
                        </tr>
                    ...
                    <div class="general-settings eventer-admin-tab-content" id="date-settings" style="display: none;">
                      <table class="form-table eventer-custom-admin-login-table">
                        ...
                        <tr valign="top">
                          <th scope="row"><?php esc_html_e('Single Event Date Format', 'eventer'); ?></th>
                          <td colspan="3">
                            <?php $value = self::get_eventer_option('eventer_date_format_single'); ?>
                            <input type="text" name="eventer_options[eventer_date_format_single]" value="<?php echo esc_attr($value); ?>">
                            <p class="description"><?php esc_html_e('Set date format for single event details page.', 'eventer'); ?> <a href="<?php echo esc_url('http://php.net/manual/en/function.date.php'); ?>" target="_blank"><?php echo esc_url('http://php.net/manual/en/function.date.php'); ?></a></p>
                          </td>
                        </tr>
                    ...
                    <div class="general-settings eventer-admin-tab-content" id="calendar-settings" style="display: none;">
                      <table class="form-table eventer-custom-admin-login-table">
                        ...
                        <tr valign="top">
                          <th scope="row"><?php esc_html_e('Start Today', 'eventer'); ?></th>
                          <td colspan="3">
                            <?php $value = self::get_eventer_option('eventer_calendar_start_today'); ?>
                            <input type="radio" name="eventer_options[eventer_calendar_start_today]" value="1" <?php checked($value, "1"); ?>> <?php esc_html_e('Yes', 'eventer'); ?>
                            <input type="radio" name="eventer_options[eventer_calendar_start_today]" value="0" <?php checked($value, "0"); ?>> <?php esc_html_e('No', 'eventer'); ?>
                            <p class="description"><?php esc_html_e('Check Yes to start the calendar from today\'s date and hide events older than today.', 'eventer'); ?></p>
                          </td>
                        </tr>
                      ...
                      <table class="form-table eventer-custom-admin-login-table">
                        ...
                        <tr valign="top">
                          ...
                          <td colspan="3">
                            ...
                            <p class="description"><?php esc_html_e('Enter Google calendar API key here to link your Google Calendars with your website. ', 'eventer'); ?><a href="https://support.imithemes.com/knowledgebase/google-calendar-api-for-events-calendar/" target="_blank"><?php esc_html_e('How to get an API key for calendar'); ?></a></p>
                        ...
                        <tr valign="top">
                          ...
                          <td colspan="3">
                            ...
                            <p class="description"><?php esc_html_e('Enter your Google Calendar ID here which you want to import in your website events.. ', 'eventer'); ?><a href="https://support.imithemes.com/knowledgebase/google-calendar-api-for-events-calendar/" target="_blank"><?php esc_html_e('How to get your calendar ID'); ?></a></p>
                          </td>
                        </tr>
                      </table>
                    </div>
                    ...
                    <div class="general-settings eventer-admin-tab-content" id="form-settings" style="display: none;">
                      <table class="form-table eventer-custom-admin-login-table">
                        ...
                        <tr valign="top">
                          <th scope="row"><?php esc_html_e('Individual Registrant Form', 'eventer'); ?></th>
                          <td colspan="3">
                            <?php $value = self::get_eventer_option('individual_registrant_fields'); ?>
                            <textarea rows="8" cols="" name="eventer_options[individual_registrant_fields]" style="width: 100%"><?php echo esc_attr($value); ?></textarea>
                            <p class="description"><?php esc_html_e('Enter content(Text/HTML) for the individual registrants in the booking form. Fields can be created at Eventer => Settings => Shortcodes', 'eventer'); ?></p>
                          </td>
                        </tr>
                      </table>
                    </div>
                    ...
                    <div class="general-settings eventer-admin-tab-content" id="ticket-images-settings" style="display: none;">
                      <table class="form-table eventer-custom-admin-login-table">
                        <tr valign="top">
                          <th scope="row">
                                <label for="image"><?php esc_html_e('Logo', 'eventer') ?></label>
                          ...
                          <td colspan="3">
                                <?php
                                $value = self::get_eventer_option('ticket_image_company_logo' );
                                if ( $value ) {
                                    $image_src = wp_get_attachment_image_src($value, 'full');
                                    $image = isset($image_src[0]) ? $image_src[0] : '';
                                } else {
                                ...
                                <p><img id="eventer_ticket_image" src ="<?php echo esc_url($image); ?>" width ="150"/></p>
                                <input id="eventer_upload_ticket_image" type="button" class="button button-primary" value="<?php echo esc_html__('Upload Image', 'eventer'); ?>" />
                                <input id="eventer_ticket_image_remove" type="button" class="button button-primary" value="<?php echo esc_html__('Remove Image', 'eventer') ; ?>" />
                                <input type="hidden" id="eventer_ticket_image_id" name="eventer_options[ticket_image_company_logo]" value="<?php echo $value; ?>" />
							  	<p class="description"><?php esc_html_e('Logo image for the event tickets. Best image width is 150px with variable height.', 'eventer'); ?></p>
                          </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <?php esc_html_e('Company Name', 'eventer'); ?>
                            </th>
                            <td colspan="3">
                                <?php $value = self::get_eventer_option('ticket_image_company_name' ); ?>
                                <input type="text" name="eventer_options[ticket_image_company_name]" value="<?php echo esc_attr($value); ?>">
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <?php esc_html_e('Company Address', 'eventer'); ?>
                            </th>
                            <td colspan="3">
                                <?php $value = self::get_eventer_option('ticket_image_company_address' ); ?>
                                <input type="text" name="eventer_options[ticket_image_company_address]" value="<?php echo esc_attr($value); ?>">
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <?php esc_html_e('Additional Notes', 'eventer'); ?>
                            </th>
                            <td colspan="3">
                                <?php $value = self::get_eventer_option('event_ticket_image_notes' ); ?>
                                <input type="text" name="eventer_options[event_ticket_image_notes]" value="<?php echo esc_attr($value); ?>">
								<p class="description"><?php esc_html_e('Show some additional information to show on the event tickets. You can override it for each event.', 'eventer'); ?></p>
                            </td>
                        </tr>
						<!--
						<tr valign="top">
							<th scope="row"><?php esc_html_e('PDF Ticket Attachment', 'eventer'); ?></th>
							<td colspan="3">
								<?php $value = self::get_eventer_option('eventer_pdf_ticket'); ?>
								<input type="radio" name="eventer_options[eventer_pdf_ticket]" value="on" <?php checked($value, 'on'); ?>> <?php esc_html_e('Yes', 'eventer'); ?>
								<input type="radio" name="eventer_options[eventer_pdf_ticket]" value="off" <?php checked($value, 'off'); ?>> <?php esc_html_e('No', 'eventer'); ?>
							</td>
						</tr>
						-->
                      </table>
                    ...
                    <div class="general-settings eventer-admin-tab-content" id="ticket-pdf-settings" style="display: none;">
                      <p class="description notice notice-warning"><?php esc_html_e('Please be noted that PDF Invoicing works only with the default payment options but not with Woocommerce. For Woocommerce use any of the free PDF invoices plugin ex. PDF Invoices & Packing Slips for WooCommerce.', 'eventer'); ?></p>
                      <table class="form-table eventer-custom-admin-login-table">
                        <tr valign="top">
                          <th scope="row">
                          ...
                          <td colspan="3">
                                <?php
                                $value = self::get_eventer_option('pdf_image_company_logo' );
                                if ( $value ) {
                                    $image_src = wp_get_attachment_image_src($value, 'full');
                                    $image = isset($image_src[0]) ? $image_src[0] : '';
                                } else {
                                ...
                                <p><img id="eventer_pdf_invoice_image" src ="<?php echo esc_url($image); ?>" width ="150"/></p>
                                <input id="eventer_upload_pdf_invoice_image" type="button" class="button button-primary" value="<?php echo esc_html__('Upload Image', 'eventer'); ?>" />
                                <input id="eventer_pdf_invoice_image_remove" type="button" class="button button-primary" value="<?php echo esc_html__('Remove Image', 'eventer') ; ?>" />
                                <input type="hidden" id="eventer_pdf_invoice_image_id" name="eventer_options[pdf_image_company_logo]" value="<?php echo $value; ?>" />
							  	<p class="description"><?php esc_html_e('Logo image for the invoices. Best image width is 150px with variable height.', 'eventer'); ?></p>
                          </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <?php esc_html_e('Email title', 'eventer'); ?>
                            </th>
                            <td colspan="3">
                                <?php $value = self::get_eventer_option('ticket_invoice_email_title' ); ?>
                                <input type="text" name="eventer_options[ticket_invoice_email_title]" value="<?php echo esc_attr($value); ?>">
								<p class="description"><?php esc_html_e('Enter title which is used for the email send with invoice.', 'eventer'); ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                            ...
                            <td colspan="3">
                                <?php $value = self::get_eventer_option('ticket_invoice_company_name' ); ?>
                                <input type="text" name="eventer_options[ticket_invoice_company_name]" value="<?php echo esc_attr($value); ?>">
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                            ...
                            <td colspan="3">
                                <?php $value = self::get_eventer_option('ticket_invoice_company_address' ); ?>
                                <input type="text" name="eventer_options[ticket_invoice_company_address]" value="<?php echo esc_attr($value); ?>">
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <?php esc_html_e('Tax ID/No.', 'eventer'); ?>
                            </th>
                            <td colspan="3">
                                <?php $value = self::get_eventer_option('ticket_invoice_vat_number' ); ?>
                                <input type="text" name="eventer_options[ticket_invoice_vat_number]" value="<?php echo esc_attr($value); ?>">
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <?php esc_html_e('Company Email', 'eventer'); ?>
                            </th>
                            <td colspan="3">
                                <?php $value = self::get_eventer_option('ticket_invoice_company_email' ); ?>
                                <input type="text" name="eventer_options[ticket_invoice_company_email]" value="<?php echo esc_attr($value); ?>">
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <?php esc_html_e('Website URL', 'eventer'); ?>
                            </th>
                            <td colspan="3">
                                <?php $value = self::get_eventer_option('ticket_invoice_company_website' ); ?>
                                <input type="text" name="eventer_options[ticket_invoice_company_website]" value="<?php echo esc_attr($value); ?>">
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <?php esc_html_e('Footer Notes', 'eventer'); ?>
                            </th>
                            <td colspan="3">
                                <?php $value = self::get_eventer_option('ticket_invoice_footer_notes' ); ?>
                                <input type="text" name="eventer_options[ticket_invoice_footer_notes]" value="<?php echo esc_attr($value); ?>"><p class="description"><?php esc_html_e('Add some optional text which is displayed at the footer of the invoices PDF. You can override it for each event.', 'eventer'); ?></p>
                            </td>
                        </tr>
                      </table>
                    </div>
                        ...
                        <select name="eventer_options[eventer_paypal_currency]">
                          <?php
                                  $options = array(
                                    ...
                                    'BRL' => esc_html__('Brazilian Real (R$)', 'eventer'),
          ...
          <?php if ($active_tab == 'design') { ?>
            <h3><?php esc_html_e('Design', 'eventer'); ?></h3>
            <div id="permalink-settings" class="ui-sortable meta-box-sortables">
              <div class="postbox">
                <div class="inside">
                  <table class="form-table eventer-custom-admin-login-table">
					<tr valign="top">
					  <th scope="row"><?php esc_html_e('Global Color', 'eventer'); ?></th>
					  <td colspan="3">
						...
						<p class="description"><?php esc_html_e('Select the color to use for the colored parts of the plugin.', 'eventer'); ?></p>
					  </td>
					</tr>

                    <tr valign="top">
                      <th scope="row"><?php esc_html_e('Global Font Family', 'eventer'); ?></th>
                      <td>
                        <?php 
							$fonts = eventer_get_google_fonts();
							$selected_font = self::get_eventer_option('eventer_google_font_global'); ?>
						<select name="eventer_options[eventer_google_font_global]" class="eventer-google-font-select">
                        ...
                        <p class="description"><?php esc_html_e('Choose global font family used for the plugin. It is primarily used for date, tickets information etc. whereas heading and body text still uses your website\'s default typography.', 'eventer'); ?></p>
                      </td>
                    </tr>
					<tr>
						<th colspan="2">
							<hr>
							<h4 style="margin-bottom: 0">Email Template Style</h4>
                        	<p class="description"><?php esc_html_e('Select style for the global email template design.', 'eventer'); ?></p>
						</th>  
					</tr>
					<tr valign="top">
					  <th scope="row"><?php esc_html_e('Background Color', 'eventer'); ?></th>
					  <td colspan="3">
						<?php $value = self::get_eventer_option('email_template_bg_color'); ?>
						<input type="text" class="eventer_default_color" name="eventer_options[email_template_bg_color]" value="<?php echo esc_attr($value); ?>">
						<p class="description"><?php esc_html_e('Select background color of the email templates.', 'eventer'); ?></p>
					  </td>
					</tr>
					<tr valign="top">
					  <th scope="row"><?php esc_html_e('Title Background Color', 'eventer'); ?></th>
					  <td colspan="3">
						<?php $value = self::get_eventer_option('email_title_bg_color'); ?>
						<input type="text" class="eventer_default_color" name="eventer_options[email_title_bg_color]" value="<?php echo esc_attr($value); ?>">
						<p class="description"><?php esc_html_e('Select background color of the email templates heading block.', 'eventer'); ?></p>
					  </td>
					</tr>
					<tr valign="top">
					  <th scope="row"><?php esc_html_e('Title Text Color', 'eventer'); ?></th>
					  <td colspan="3">
						<?php $value = self::get_eventer_option('email_title_text_color'); ?>
						<input type="text" class="eventer_default_color" name="eventer_options[email_title_text_color]" value="<?php echo esc_attr($value); ?>">
						<p class="description"><?php esc_html_e('Select text color of the email templates heading.', 'eventer'); ?></p>
					  </td>
					</tr>
					<tr valign="top">
					  <th scope="row"><?php esc_html_e('Content Background Color', 'eventer'); ?></th>
					  <td colspan="3">
						<?php $value = self::get_eventer_option('email_content_bg_color'); ?>
						<input type="text" class="eventer_default_color" name="eventer_options[email_content_bg_color]" value="<?php echo esc_attr($value); ?>">
						<p class="description"><?php esc_html_e('Select background color of the email templates content block.', 'eventer'); ?></p>
					  </td>
					</tr>
					<tr valign="top">
					  <th scope="row"><?php esc_html_e('Content Text Color', 'eventer'); ?></th>
					  <td colspan="3">
						<?php $value = self::get_eventer_option('email_content_text_color'); ?>
						<input type="text" class="eventer_default_color" name="eventer_options[email_content_text_color]" value="<?php echo esc_attr($value); ?>">
						<p class="description"><?php esc_html_e('Select text color of the email templates content.', 'eventer'); ?></p>
					  </td>
					</tr>
					<tr valign="top">
					  <th scope="row"><?php esc_html_e('Footer Text Color', 'eventer'); ?></th>
					  <td colspan="3">
						<?php $value = self::get_eventer_option('email_footer_text_color'); ?>
						<input type="text" class="eventer_default_color" name="eventer_options[email_footer_text_color]" value="<?php echo esc_attr($value); ?>">
						<p class="description"><?php esc_html_e('Select text color of the email templates footer content.', 'eventer'); ?></p>
					  </td>
					</tr>
                    <tr>
                        <td colspan="4">
                            <button type="button" id="reset-settings" class="button"><?php esc_html_e('Reset to Default', 'eventer'); ?></button>
                        </td>
						<script type="text/javascript">
							document.addEventListener('DOMContentLoaded', function () {
								document.getElementById('reset-settings').addEventListener('click', function () {
									var elements = document.querySelectorAll('input[type="text"], select');
									elements.forEach(function (element) {
										if (element.tagName.toLowerCase() === 'input') {
											element.value = '';
											element.dispatchEvent(new Event('input')); // Trigger input event for immediate UI update

											// Reset color picker
											if (element.classList.contains('wp-color-picker')) {
												var colorPickerContainer = element.closest('.wp-picker-container');
												var colorPickerButton = colorPickerContainer.querySelector('.wp-color-result');
												colorPickerButton.style.backgroundColor = ''; // Update color picker button background
												element.value = ''; // Clear the input value
												jQuery(element).wpColorPicker('color', ''); // Reset the color picker value
											}
										} else if (element.tagName.toLowerCase() === 'select') {
											element.selectedIndex = 0;
											element.dispatchEvent(new Event('change')); // Trigger change event for immediate UI update
										}
									});
								});
							});
          ...
          <?php if ($active_tab != 'shortcode' && $active_tab != 'bookings' && $active_tab != 'activation' && $active_tab != 'import' && $active_tab != 'checkin') { ?>
                ...
                <table class="form-table eventer-custom-admin-login-table">
                  ...
                  <tr valign="top" class="eventer-custom-admin-screen-background-section">
                    ...
                    <td>
                      ...
                      <!--<img id="compact-design" src="<?php echo EVENTER__PLUGIN_URL . 'images/compact.png'; ?>">                                                                                                                     <img id="minimal-design" src="<?php echo EVENTER__PLUGIN_URL . 'images/minimal.png'; ?>">-->
                ...
                <table class="form-table eventer-custom-admin-login-table" id="eventer-slider-area-start">
                  ...
                  <?php }
                    ...
                    <tr valign="top" class="eventer-custom-admin-screen-background-section">
                      <th scope="row"><?php esc_html_e('Organizer', 'eventer'); ?></th>
                      <td>
                        <select multiple class="eventer_terms eventer_select_val" data-sattr="slider_organizer" id="slider_terms_organizers">
                          <?php
                                    $options = eventer_get_terms('eventer-organizer');
                                    foreach ($options as $id => $label) { ?>
                            <option value="<?php echo esc_attr($id); ?>">
            ...
            <div class="postbox">
              <div class="inside">
                ...
                <table class="form-table eventer-custom-admin-login-table">
                  ...
                  <tr valign="top" class="eventer-custom-admin-screen-background-section">
                    <th scope="row"><?php esc_html_e('Field Placeholder', 'eventer'); ?></th>
                    <td>
                      <input type="text" class="eventer_select_val" data-sattr="label" id="form_field_placeholder">
                      <p class="description"><?php esc_html_e('Enter placeholder for text/textarea of the field.', 'eventer'); ?></p>
                    </td>
                  </tr>
                ...
                <table class="wp-list-table widefat eventer-bookings">
                  ...
                  <tbody>
                    ...
                    <?php
                              ...
                              foreach ($reg_details as $registrant) {
                                ...
                                if (isset($user_system['tickets_created']) && !empty($user_system['tickets_created'])) {
                                  ...
                                  foreach ($user_system['tickets_created'] as $key => $value) {
                                    ...
                                    $all_tickets_path .= implode($separator, $value) . $separator;
                                    $count++;
                                  }
                                }
                                if (get_post_type($registrant->eventer) == 'eventer') {
                                  ...
                                  if ($tickets_normal) {
                                   ...
                                   // print_r( [ $all_tickets_details, $registrants_normal, $services_normal ] );exit();
                                  if ($services_normal) {
                                ...
                                // print_r( $all_tickets_details );exit();
                        ...
                        <tr class="eventer_woo_expandable" id="registrant-details-<?php echo esc_attr($registrant->id); ?>" style="display: none">
                          ...
                          <td colspan="8">
                            <table style="width:100%">
                              ...
                              <?php
                                          if (!empty($all_tickets_details)) {
                                            foreach ($all_tickets_details as $ticket_detail) {
                                              ...
                                              foreach ($registrants_ticket_wise as $index => $registrant_each) {
                                                if ( isset( $registrant_each['name'] ) ) {
                                                   $registrant_name .= $registrant_each['name'] . '<br/>';
                                                } else {
                                                  $registrant_name .= $registrant_each['Registrant name'.$index] . '<br/>';
                                                }

                                                if ( isset( $registrant_each['email'] ) ) {
                                                   $registrant_email .= $registrant_each['email'] . '<br/>';
                                                } else {
                                                  $registrant_email .= $registrant_each['Registrant email'.$index] . '<br/>';
                                                }
                                              }
                              ...
                              <tfoot>
                                <tr>
                                  <td>
                                    <?php if ($woocommerce_ticketing != 'on') { ?>
                                  ...
                                  <td>
                                    <a title="<?php esc_html_e('Create & Send Tickets', 'eventer'); ?>" href="<?php echo esc_url($order_received_URL); ?>"><span class="dashicons dashicons-paperclip"></span>
                                    </a>
                                  </td>
                                  <td>
                                  ...
                                  <?php
								  // Change download tickets to PDF tickets download in June 2024 later 3.8.4 version
								  if ($allow_download == 1) {
                                     $pdf_download_url = get_pdf_download_url($registrant->id);
									 echo '<a href="'.$pdf_download_url.'" title="' . esc_html__('Download Tickets', 'eventer') . '" style="cursor:pointer"><span class="dashicons dashicons-download"></span></a>';
								  }
								  ?>
                                  </td>
                                  <td></td>
                            ...
                            <div class="main">
                              <form>
                                <ul class="form-style-1">
                                  ...
                                  <li>
                                    <label><?php esc_html_e('Ticket QR code', 'eventer'); ?>
                                      <span class="required">*</span>
                                    </label>
            ...
            <div class="postbox">
              <div class="inside">
                <?php echo '<div class="wrap"><div id="icon-tools" class="icon32"></div>';
                  ...
                  <!--<p>Please add specification for csv labels, please upload minimum csv files as per server load.</p>                                                                                                               <p>Select unique field of csv file, so that it could create only new listings.</p>-->
