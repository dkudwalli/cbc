...
require_once __DIR__ . '/bookings-details.php';
...
if (!function_exists('eventer_add_form_fields_venue')) {
  ...
  function eventer_add_form_fields_venue($term, $taxonomy)
  {
	...
	*/
      ...
      {
        eventer_handle_export_bookings_csv_ajax();
      }
    }
	...
	*/
      ...
      {
        eventer_handle_get_booked_tickets_ajax();
      }
	...
	*/
      ...
      {
        eventer_handle_update_booked_tickets_ajax();
      }
    ...
    {
      eventer_handle_get_term_details_ajax();
    }
    ...
    {
      eventer_handle_export_registrants_ajax();
    }

    function eventer_checkin_process_ticket()
    {
      eventer_handle_checkin_process_ticket_ajax();
    }
    ...
    {
      eventer_handle_coupon_refresh_ajax();
    }
    ...
    {
      eventer_handle_delete_bookings_ajax();
    }
