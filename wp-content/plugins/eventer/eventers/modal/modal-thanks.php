...
{
   $thanks_content .= '<label class="eventer-label-bi-tickets">'.esc_html__('Booked Tickets', 'eventer').'</label>';
...
$thanks_modal_show = '<div class="eventer eventer-event-single eventer-modal-static" id="eventer-ticket-confirmation" data-eid="'.get_the_ID().'">
