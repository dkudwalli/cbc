    ...
    <div class="eventer-product-r2">
        ...
        if (!empty($params['tickets'])) {
            ...
            if ($params['registration'] == '1') {
                ?>
            <div>
                <a href="<?php echo $params['regcustom']; ?>" target="<?php echo esc_attr($params['regcustomtarget']); ?>" class="eventer-btn eventer-btn-primary"><?php esc_html_e('Book Now', 'eventer'); ?></a>
            </div>
        <?php
            echo '</div>';
        }
