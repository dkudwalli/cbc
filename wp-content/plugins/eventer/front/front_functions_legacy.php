...
if (!function_exists('eventer_month_wise_events')) {
  ...
  {
    eventer_handle_month_wise_events_ajax();
  }
...
if (!function_exists('eventer_registrant_tickets')) {
  ...
  {
    eventer_handle_registrant_tickets_ajax();
  }
...
{
  eventer_handle_confirm_payment_stripe_ajax();
}
...
if (!function_exists('eventer_contact_organizer')) {
  ...
  {
    eventer_handle_contact_organizer_ajax();
  }
...
{
  eventer_handle_generate_ticket_qrcode_ajax();
}
...
{
  eventer_handle_dynamic_ticket_area_ajax();
}
...
{
  eventer_handle_validate_coupon_ajax();
}
