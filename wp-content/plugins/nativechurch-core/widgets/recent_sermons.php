			 ...
			 /* end check if content has sortcode video */
				...
				if(!empty($custom['imic_sermons_url'][0]) && $flag==0){
                               ...
                               $liFirst .='<li class="item sermon featured-sermon">
									...
									if (!empty($attach_full_audio)) {
										$liFirst .= '<a href="' . $attach_full_audio . '" download data-placement="top" data-toggle="tooltip" data-original-title="' . __('Download Audio', 'imithemes') . '"><i class="fa fa-download"></i></a>';
									}
									 $attach_pdf= imic_sermon_attach_full_pdf($post->ID);
									if (!empty($attach_pdf)) {
									$liFirst .= '<a href="' . $attach_pdf . '" download data-placement="top" data-toggle="tooltip" data-original-title="' . __('Download PDF', 'imithemes') . '"><i class="fa fa-book"></i></a>';
									}
